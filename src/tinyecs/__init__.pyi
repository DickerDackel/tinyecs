...
# Fucking typehinting system can't work with functions using *args, **kwargs.
...
class SystemFunction(Protocol):
    def __call__(self, eid: EntityID, *cids: ComponentID, has_property: set[Property], **kwargs: dict[str, object]) -> Any: ...
...
def add_system(fkt: Callable[..., None], *cids: ComponentID) -> None: ...
def remove_system(fkt: Callable[..., None]) -> None: ...
...
def eids_by_cids(*cids: ComponentID, has_properties: OptionalProperties = None) -> list[tuple[EntityID, Component]]: ...
...
def eid_of_comp(comp: Component) -> EntityID: ...
